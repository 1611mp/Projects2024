...
class Calculator:
    ...
    def create_display_frame(self):
        frame = Frame(self.window, height = 221, bg=BEIGE_FRAME)
    ...
    def create_digit_buttons(self):
        for digit,grid_value in self.digits.items():
            button = Button(self.buttons_frame, text = str(digit),bg= WHITE,
